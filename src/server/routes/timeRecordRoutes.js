...
projectRouter.post(
  '/start',
  validate(timeRecordSchema.required()),
  timeRecordController.start,
);
projectRouter.put('/stop/:id', timeRecordController.stop);
projectRouter.get(
  '/allByProjectId/:projectId',
  timeRecordController.getAllByProjectId,
);
projectRouter.get(
  '/allBySubtaskId/:subtaskId',
  timeRecordController.getAllBySubtaskId,
);
