    ...
    <>
      <dialog id="delete_subtask" className="modal modal-middle">
        <div className="modal-box">
          <h3 className="font-bold text-lg text-center">Are you sure you want to delete this subtask?</h3>
          <div className="divider"></div>
          <p className="py-4">
            This will permanently delete the subtask and its time entries. You cannot undo this action.
          </p>
          <div className="modal-action">
            <button className="btn" onClick={() => document.getElementById('delete_subtask').close()}>
              Cancel
            </button>
