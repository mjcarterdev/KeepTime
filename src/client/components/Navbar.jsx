...
const NavBar = ({ location = '' }) => {
  ...
  return (
    <nav className="absolute top-0 z-30 w-full h-16 p-2 px-1 rounded-md py-0w-full border bg-neutral border-gray-100 rounded-md shadow-[2px_4px_5px_2px_#00000024] min-h-[4rem] py-0w-full bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-40 text-black navbar max-h-16">
